    ...
    <body class="fixed-left">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb float-right">
										...
										<li class="breadcrumb-item active">Conta(s) Receita(s) Cadastro</li>									
                                    </ol>									
                                    <div class="clearfix"></div>									
                                </div>
                            </div>
						...
						<?php
										...
										try{
											$sql = "SELECT 	cr.id_conta_receita, 
													...
													where cr.id_conta_receita = :id_conta_receita ";
										...
										<form  id="form" name="form" method='post' action='' class="form-horizontal" role="form"  data-parsley-validate novalidate>
											...
											<div class="form-group row">
												<div class="col-sm-offset-4 col-sm-8">												
													...
													<input type="hidden" id="codigo" name="codigo" value="<?php echo($contaReceita);?>" />
												</div>
											</div>
										</form>
								</div>
       ...
       <script>
        ...
        <script type="text/javascript">
			...
			function validaForm(){
				$.ajax({url: 'conta-receita-cadastro-u.php',
						type:'POST',
						data: $('#form').serialize(),  
