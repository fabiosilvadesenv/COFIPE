                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Lançamento(s)</h4>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
										...
										<p class="text-muted font-10 m-b-7">
											<?php if ($acaoNovo == 1){ ?>
												<button class="btn btn-success waves-effect waves-light btn-sm m-b-1" onclick="location.href='form-lancamento-cadastro.php';"  >
										...
										<table id="responsive-datatable2" name="responsive-datatable2"  class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
													<thead>
														<tr>
                                                            <th>Código</th>
                                                            <th>Responsável</th>
															...
															if($rs->execute()){
																if($rs->rowCount() > 0){
																	while($row = $rs->fetch(PDO::FETCH_OBJ)){														
																		...
																		echo "<tr>";
																		echo "	<td>$row->id_lancamento</td>";
                                                                        echo "	<td>$row->tx_login_nome</td>";
																		...
																		echo "	<td class=\"actions\">";
																				if ($acaoEditar == 1){																	
																					echo "		<button title=\"Editar Lançamento!\"	onClick='javascript:editar(\"$row->id_lancamento\")'	class=\"btn btn-icon waves-effect waves-light btn-warning m-b-1\"> 	<i class=\"fa fa-pencil\"></i> 		</button>";
																				}
																				if ($acaoExcluir == 1){
																					echo "		<button title=\"Excluir Lançamento!\" onClick='javascript:apagar(\"$row->id_lancamento\",\"$row->tx_observacao_informativo\")' class=\"btn btn-icon waves-effect waves-light btn-danger m-b-1\"> 	<i class=\"fa fa fa-trash-o\"></i> 	</button>";
																				}															
																		echo "	</td>";
																		#is_numeric($id)
       ...
       <script>
        ...
        <script type="text/javascript">
			...
			function apagar(codigo, nome){
				if (window.confirm('Deseja apagar o lançamento: "' + nome +'"?')) {  
				  $.ajax({  url: 'conta-lancamento-cadastro-u.php?act=d&rd='+codigo,
					type:'GET',
						data: $('#form').serialize(),  
			...
			function editar(codigo){
				location.href = 'form-lancamento-cadastro.php?codigo='+codigo ;
			}
